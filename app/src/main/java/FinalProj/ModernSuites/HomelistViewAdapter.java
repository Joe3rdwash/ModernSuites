...
public class HomelistViewAdapter extends BaseAdapter {
    ...
    private ArrayList<ClassHomeListView> beanClassArrayList;


    public HomelistViewAdapter(Context context, ArrayList<ClassHomeListView> beanClassArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ClassHomeListView beanClass = (ClassHomeListView) getItem(position);
