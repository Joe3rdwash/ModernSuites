...
public class listViewAdapter extends BaseAdapter {
    ...
    private ArrayList<ClassListView> beanClassArrayList;


    public listViewAdapter(Context context, ArrayList<ClassListView> beanClassArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ClassListView beanClass = (ClassListView) getItem(position);
